...
public class QuizResourceIT {
    ...
    private static final LocalDate DEFAULT_TIME_BEGIN = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_TIME_BEGIN = LocalDate.now(ZoneId.systemDefault());
