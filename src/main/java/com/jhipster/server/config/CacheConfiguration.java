...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.jhipster.server.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.jhipster.server.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.jhipster.server.domain.Notification.class.getName());
            ...
            createCache(cm, com.jhipster.server.domain.Quiz.class.getName() + ".subjects");
            ...
            createCache(cm, com.jhipster.server.domain.Subject.class.getName() + ".quizzes");
