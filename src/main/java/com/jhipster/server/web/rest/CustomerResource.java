...
import com.jhipster.server.service.CustomerService;
import com.jhipster.server.web.rest.errors.BadRequestAlertException;
import com.jhipster.server.service.dto.CustomerDTO;
...
/**
 * REST controller for managing {@link com.jhipster.server.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
public class CustomerResource {
    ...
    public ResponseEntity<List<CustomerDTO>> getAllCustomers(Pageable pageable, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
